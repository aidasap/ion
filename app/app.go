...
import (
	...
	"github.com/idep/ion/docs"

	"github.com/idep/ion/x/uptake"
	uptakekeeper "github.com/idep/ion/x/uptake/keeper"
	uptaketypes "github.com/idep/ion/x/uptake/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "idep"
	Name                 = "ion"
)
...
type App struct {
	*baseapp.BaseApp
	...
	UptakeKeeper     uptakekeeper.Keeper
...
func New(
	...
	app.UptakeKeeper = uptakekeeper.NewKeeper(appCodec, keys[uptaketypes.StoreKey])
	...
	app.mm = module.NewManager(
		...
		transferModule,
		monitoringModule,
		uptake.NewAppModule(appCodec, app.UptakeKeeper, app.AccountKeeper, app.BankKeeper),
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(uptaketypes.ModuleName)
